defmodule Catenary.Live.ReactionsExplorer do
  ...
  defp for_display({a, l, e} = entry, reactions, clump_id) do
    ...
    ~s(<button value="#{entry_str}" phx-click="view-entry">) <>
      ~s(<div class="rounded-full border border-slate-200 dark:border-slate-700 px-5 py-1 transition-colors hover:border-amber-500 dark:hover:border-amber-400 inline-flex items-center gap-1.5">) <>
